...
$code = $_GET["code"];
$getEmailQuery = mysqli_query($conn, "SELECT resetPasswordsEmail FROM resetPasswords WHERE resetPasswordsCode = '$code';");
...
if (isset($_POST["password"])) {
    ...
    $email = $row["resetPasswordsEmail"];
    $query = mysqli_query($conn, "UPDATE admins SET adminsPassword = '$password' WHERE adminsEmail = '$email'");

    if($query) {
        $query = mysqli_query($conn, "DELETE FROM resetPasswords WHERE resetPasswordsCode = '$code';");
        exit('
            <!DOCTYPE html>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="text-align:center;padding: 0 30px 40px">
                                                    ...
                                                    <br>
                                                    <p style="margin: 0; font-size: 13px; line-height: 22px; color:#9ea8bb;"> <a href="../index.php"> Login now </a></p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
